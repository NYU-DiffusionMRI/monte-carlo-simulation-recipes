function [x, y, rs] = init_positions(rinit) 

% creates initial positions x,y and rescaled radii rs, of disks 
% for Donev's C++ input file, based on initial radii rinit (column),
% and saves them in the file specified in readfilename
%
%---------------------------------------------------------
